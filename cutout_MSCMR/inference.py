...
def infer(model, criterion, dataloader_dict, device):
    ...
    test_folder = "/data/datasets/scribble/val/images/"
    label_folder = "/data/datasets/scribble/val/labels/"
    output_folder = "/data/datasets/scribble/output_UNet_cutout_wo_clr/"
