...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/data4/experiments_resume/cutout_MSCMR_5/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda', type=str,
                        help='device to use for training / testing')
    parser.add_argument('--GPU_ids', type=str, default='3', help='Ids of GPUs')
...
def main(args):
    ...
    if args.eval:
        test_stats = evaluate(model, criterion, postprocessors, dataloader_val_dict, device, args.output_dir,
                              visualizer, 0, writer)
