...
def Cutmix_augment(x, l, device, beta=1):
    ...
    for index in range(x.shape[0]):
        ...
        x[index, :, bbx1:bbx2, bby1:bby2] = x_flip[index, :, bbx1:bbx2, bby1:bby2]
        l[index, :, bbx1:bbx2, bby1:bby2] = l_flip[index, :, bbx1:bbx2, bby1:bby2]
...
def mix_fixboxs(outputs, boxs, device):
    ...
    for index in range(src_masks.shape[0]):
        ...
        new_masks[index, :, bbx1:bbx2, bby1:bby2] = masks_flip[index, :, bbx1:bbx2, bby1:bby2]
    return new_masks
